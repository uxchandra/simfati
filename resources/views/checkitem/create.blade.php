...
@section('content')
    <div class="section-header">
        <h1>Tambah Indikator Checksheet</h1>
        <div class="ml-auto">
                    ...
                    <form id="checkitem_form">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div id="check_items_container">
                                                <!-- Dynamic check items akan ditambahkan di sini -->
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-dark ml-2" onclick="window.location.href='{{ route('checkitem.index') }}'">
    ...
    <script>
        ...
        $(document).on('click', '.add-standard', function() {
            ...
            let standardIndex = standardsContainer.find('.standard-item').length;
